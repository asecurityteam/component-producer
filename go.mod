...
require (
	...
	github.com/asecurityteam/component-httpclient v0.6.2
...
require (
	...
	github.com/asecurityteam/logevent/v2 v2.0.3 // indirect
...
// The following dependencies are pinned to versions compatible with Benthos v3.65.0.
// Updating them further will break Benthos due to upstream API changes.
